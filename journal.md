...
Thank you John, Jerry for your service to our country and helping out with getting some of your games out there to our community for next to nothing. You guys are awesome on so many levels. Thank you Franklin's Moving Company for helping out for also next to nothing and driving hundreds of miles a total of 12 hours in one single day just to pick up a Fast N Furious Superbike (that thing is a beast) and Spin-N-Win that didn't fit in the 29 foot truck on the initial load. Franklin is such a wonderful person he has literally brought half of this stuff around for us with a sprained knee, he is a great guy and always there when you need him! He treats people very kindly, being a family man and father himself he is always looking out for the kids and just someone who I have seen always helping others and holding fairness as a top virtue. He goes above and beyond to look out for others.

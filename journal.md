...
A job lost, a parent lost, an arrest made, a medical emergency... these are all losses that some of the staff at our participating locations are far too experienced in seeing displace kids on a regular basis. These are many of the common reasons people become forgotten, even snubbed, left behind and without a home. Even worse, without a family. Like that crumpled piece of paper you feel is deserving of a high five from your colleagues or friends after shooting that thing you claimed was a three (even though at that range you know its a 2). Win's a win.
When you add a win when you add a win into that thunderstorm, whether its Frogger not getting pancaked, running that ball across the endzone in your favorite jersey, or saying something like "Get over here!" as you fire a rope dart at your buddy in the third round in a timeless, Sub Zero versus Scorpion face off... the mechanism is pretty well documented either way. 
Trauma dysregulates the nervous system — kids stuck in fight-or-flight can’t learn, can’t sleep, can’t regulate. Play is one of the few things that reliably pulls them out of that state. The more ridiculously entertaining and memorable it is, the better. Can you recall the first time you crawled in a checkered cab with your hair spiked green and jumped the hills of San Francisco listening to a soundtrack by The Offspring??? Or maybe you remember choosing who gets to be the ape or the werewolf or lizard then coordinating which buildings you're climbing next together to eat helicopters and other ridiculousness.
Dumb, ridiculous, feel good wins. Some of the best wins be like that. I'm talking about the pinnacle of fun where the worries lift away for a moment. You remember few things from your childhood, I can tell you every time I went into an arcade, every family or friend that was there and half of what we played in there. I know that sounds ridiculous  but for some reason my memory logged it. I mentioned in a earlier journal post that my first memories of my father was Asteroids and Galaga. The thing that got me interested in learning to work a computer as a child was simply playing the game and booting the terminal to play a game off the command back in the day.
